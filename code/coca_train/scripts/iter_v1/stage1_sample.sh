...
torchrun --nproc_per_node 8 --nnodes=4 --node_rank=$RANK --master_addr=$MASTER_ADDR --master_port=10035 ./off_policy_GRPO/sample.py --output_dir /dmx-csy-mix01/cog3/permanent/qkchang/shliu19/critique/experiments/GRPO/qwen2.5/sample_ablation/top3/sample_output --actor_model_path /dmx-csy-mix01/cog3/permanent/qkchang/pretrained_models/Qwen2.5-VL-7B-Instruct/ --critic_model_path /dmx-csy-mix01/cog3/permanent/qkchang/shliu19/critique/models/pretrained_critic_2.5vl_base/ --pigai_model_path /dmx-csy-mix01/cog3/permanent/qkchang/shliu19/critique/models/pigai_model/checkpoint-467/ --dataset_path /dmx-csy-mix01/cog3/permanent/qkchang/shliu19/critique/dataset/train_filter_10w_sample_0.json --qwen2vl_infer_batch 1 --num_generation 16 --top_p 1.0 --top_k 50 --temperature 0.7 --max_len 4096 --gpu_memory_utilization 0.4 --exp_id sample_iter_0
...
torchrun --nproc_per_node 8 --nnodes=4 --node_rank=$RANK --master_addr=$MASTER_ADDR --master_port=10035 ./swift/cli/rlhf.py --rlhf_type grpo --model /dmx-csy-mix01/cog3/permanent/qkchang/shliu19/critique/models/pretrained_critic_2.5vl_base/ --external_plugins ./examples/train/grpo/plugin/plugin.py --reward_funcs format --use_vllm false --vllm_gpu_memory_utilization 0.4 --temperature 0.7 --top_p 1.0 --top_k 50 --train_type full --torch_dtype bfloat16 --dataset /dmx-csy-mix01/cog3/permanent/qkchang/shliu19/critique/experiments/GRPO/qwen2.5/sample_ablation/top3/sample_output/sample_iter_0/dataset/critic --split_dataset_ratio 0 --max_completion_length 4096 --num_train_epochs 1 --per_device_train_batch_size 1 --per_device_eval_batch_size 1 --learning_rate 1e-06 --warmup_ratio 0 --lr_scheduler_type constant --gradient_accumulation_steps 64 --eval_strategy no --save_strategy epoch --save_total_limit 10 --logging_steps 3 --max_length 4096 --output_dir /dmx-csy-mix01/cog3/permanent/qkchang/shliu19/critique/experiments/GRPO/qwen2.5/sample_ablation/top3/model_output/iter_0/critic --dataloader_num_workers 4 --dataset_num_proc 4 --num_generations 16 --repetition_penalty 1.05 --system ./prompt.txt --log_completions true --num_iterations 1 --async_generate false --beta 0 --add_version False --model_type qwen2_5_vl --create_checkpoint_symlink True --freeze_vit True
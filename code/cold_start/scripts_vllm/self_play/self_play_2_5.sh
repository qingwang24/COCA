...
output_dir=/train34/cog8/permanent/bhwei2/pfhu6/shliu19/code/MCTS/critique/code/v3/experiments/self_play/score_loss_0.1/debug/checkpoint-2800
...
# critique_model_path=/train34/cog8/permanent/bhwei2/pfhu6/shliu19/code/MCTS/critique/code/v3/experiments/train_critique/0.1score_loss/checkpoint-2800
critique_model_path=critique_model_path=/train21/cog8/permanent/qkchang/shliu19/critique/code/v5/experiments/train_critique/checkpoint-3500
...
dataset_path=/train34/cog8/permanent/bhwei2/pfhu6/shliu19/code/MCTS/critique/code/v1/dataset/test_val_all.json
